//AppTools\src\components\common\EntityTable\components\BatchActions\components\ExportTable\components\TableExportSummary.jsx
import React from 'react';

const TableExportSummary = ({
  selectedCount,
  itemLabel,
  exportFormat,
  selectedColumns = [],
...
export default TableExportSummary;
