...
function BrandDetail() {
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-gray-900 dark:text-gray-100">{brand.name}</p>
                  </div>

                  <div>
                    <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Slug</h3>
                    <p className="mt-1 text-gray-900 dark:text-gray-100">{brand.slug || '-'}</p>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-yellow-800 dark:text-yellow-200">
                        Marque non synchronisée
                      </h3>
                      <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                        <p>Cette marque n'a pas encore été synchronisée avec WooCommerce.</p>
                        <button
  ...
  return (
    <EntityDetail
      ...
      baseRoute="/products/brands" // Chemin selon votre structure de route
