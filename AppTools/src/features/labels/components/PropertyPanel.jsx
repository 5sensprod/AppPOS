...
const PropertyPanel = ({ selectedProduct }) => {
  ...
  const handleFieldChange = (fieldKey) => {
    ...
    if (field) updateElement(selectedId, { dataBinding: field.key, text: field.value });
  };
    ...
    <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
      <div className="flex items-center gap-4 px-3 py-2 max-w-4xl w-[min(90vw,800px)]">
        ...
        {/* <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="px-2 py-1 text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded whitespace-nowrap">
          ...
          <>
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <select
                ...
                className="px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white max-w-[220px]"
              >
