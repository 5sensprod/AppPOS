...
const CartItem = ({ item, onUpdateQuantity, onRemove, onApplyDiscount }) => {
  ...
  const handleDiscountClick = () => {
    console.log('🔍 [CartItem] handleDiscountClick appelé avec item:', item);
  ...
  const showDiscountButton = onApplyDiscount !== null;
  ...
  return (
    <div className="flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-600">
      ...
      <div className="flex items-center space-x-2">
        {/* ✅ BOUTON RÉDUCTION - AFFICHÉ UNIQUEMENT SI PERMISSIONS OK */}
        {showDiscountButton && (
          <button
